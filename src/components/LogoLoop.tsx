        ...
        const content = isNodeItem ? (
          ...
          <img
            className={cx(
              ...
              'motion-reduce:transition-none',
              scaleOnHover &&
                'transform-gpu scale-100 transition-transform duration-600 ease-[cubic-bezier(0.16,1,0.3,1)] will-change-transform group-hover/item:scale-110'
            )}
            src={(item as any).src}
      ...
      <div ref={containerRef} className={rootClasses} style={containerStyle} role="region" aria-label={ariaLabel}>
              ...
              <>
                <div
                  ...
                  className={cx(
                    ...
                    'bg-[var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))]',
        ...
        <div
          className={cx(
            ...
            'motion-reduce:transform-none touch-none cursor-grab active:cursor-grabbing',

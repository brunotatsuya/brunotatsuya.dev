...
const useResizeObserver = (
  ...
  }, [callback, elements, watchA, watchB, watchC, watchD])
}
...
const useImageLoader = (
  ...
  }, [onLoad, seqRef, watchA, watchB, watchC, watchD])
}
  ...
  ({
    ...
    const handlePointerMove = useCallback(
      (event: React.PointerEvent<HTMLDivElement>) => {
        ...
        const velocity = (current - dragLastRef.current) / dt
        ...
        if (seqSize > 0) {
          ...
          const transformValue = isVertical
            ? `translate3d(0, ${-offsetRef.current}px, 0)`
            : `translate3d(${-offsetRef.current}px, 0, 0)`
          trackRef.current?.style?.setProperty('transform', transformValue)
        }
        velocityRef.current = -(velocity * 1000)
      },
        ...
        const content = isNodeItem ? (
          ...
          <img
            className={cx(
              ...
              'motion-reduce:transition-none',
              scaleOnHover &&
                'scale-100 transform-gpu transition-transform duration-600 ease-[cubic-bezier(0.16,1,0.3,1)] will-change-transform group-hover/item:scale-110'
            )}
            src={item.src}
            srcSet={item.srcSet}
            sizes={item.sizes}
      ...
      >
              ...
              <>
                <div
                  ...
                  className={cx(
                    ...
                    'bg-(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))',
        ...
        <div
          className={cx(
            ...
            'cursor-grab touch-none active:cursor-grabbing motion-reduce:transform-none',
